"""
write python alexnet code to understand wholeflow,
* this is to understand alexnet flow
* for each step, annotate role
* display shape for each step
* must contain whole flow of alexnet
* batch size 5
"""
...
Forward Pass Shape Analysis:
Input: torch.Size([5, 3, 227, 227])
After Conv1 + Pool: torch.Size([5, 96, 55, 55])
After Conv2 + Pool: torch.Size([5, 256, 27, 27])
After Conv3: torch.Size([5, 384, 13, 13])
After Conv4: torch.Size([5, 384, 13, 13])
After Conv5 + Pool: torch.Size([5, 256, 6, 6])
After FC layers: torch.Size([5, 1000])

Results:
Output logits shape: torch.Size([5, 1000])
Probability shape: torch.Size([5, 1000])
Predicted classes: tensor([483, 128, 892, 761, 345])
"""
