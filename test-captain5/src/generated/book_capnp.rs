...
pub mod car {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 138] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(21, 0, 0, 0, 199, 1, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(98, 111, 111, 107, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 67, 97, 114, 0, 0),
...
pub mod book {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 113] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(98, 111, 111, 107, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 66, 111, 111, 107, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
...
pub mod fruit {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 94] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(98, 111, 111, 107, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 70, 114, 117, 105, 116),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
...
pub mod book_list {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 37] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(98, 111, 111, 107, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 66, 111, 111, 107, 76),
...
pub mod shop {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_fruits(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::book_capnp::fruit::Owned>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(3), ::core::option::Option::None)
    }
    #[inline]
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_fruits(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::book_capnp::fruit::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(3), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_fruits(&mut self, value: ::capnp::struct_list::Reader<'_,crate::book_capnp::fruit::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(3), value, false)
    }
    #[inline]
    pub fn init_fruits(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::book_capnp::fruit::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 178] = [
      ...
      ::capnp::word(25, 0, 0, 0, 7, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(21, 0, 0, 0, 55, 2, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(98, 111, 111, 107, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 83, 104, 111, 112, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
